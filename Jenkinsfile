    ...
    stages {
       stage ('GIT') {
        ...
        stage ('Test API'){
            steps{
                 script{
                    SoapUIPro environment: '', pathToProjectFile: '/home/devlocal/SmartBear/ReadyAPI-3.42.0/bin/Game_Crude2.xml', pathToTestrunner: '/home/devlocal/SmartBear/ReadyAPI-3.42.0/bin/testrunner.sh', projectPassword:'', testCase: '', testCaseTags: '', testSuite: '', testSuiteTags: ''
